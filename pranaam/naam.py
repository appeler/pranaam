...
class Naam(Base):
    ...
    def pred_rel(
        ...
        try:
            ...
            muslim_probs = [float(np.around(prob[1] * 100)) for prob in probabilities.numpy()]
    ...
    @classmethod
    def _load_model_with_compatibility(cls, model_path: str, lang: str) -> tf.keras.Model:
        ...
        try:
            ...
            if "keras 3" in str(e).lower() or "file format not supported" in str(e).lower():
                raise RuntimeError(
